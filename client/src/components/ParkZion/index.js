...
function Zion() {
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Zion National Park</h1>
            ...
            <div className='slider'>
                ...
                {SliderDataZion.map((slide, index) => {
                    return (
