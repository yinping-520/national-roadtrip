...
function Glacier() {
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Glacier National Park</h1>
            <h2 className='city'>Montana, USA</h2>
            <div className='slider'>
                ...
                {SliderDataGlacier.map((slide, index) => {
                    return (
