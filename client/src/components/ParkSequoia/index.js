...
import { SliderDataSequoia } from '../SliderData';
import { FaArrowAltCircleRight, FaArrowAltCircleLeft } from 'react-icons/fa';
import tree from '../assets/big-tree.jpg';

function Sequoia() {
    const [current, setCurrent] = useState(0); // for next & prev slides
    const length = SliderDataSequoia.length;
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Sequoia National Park</h1>
            ...
            <div className='slider'>
                ...
                {SliderDataSequoia.map((slide, index) => {
                    return (
