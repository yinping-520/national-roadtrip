...
import { SliderDataRockyMtn } from '../SliderData';
import { FaArrowAltCircleRight, FaArrowAltCircleLeft } from 'react-icons/fa';
import fish from '../assets/fishing.jpg';

function RockyMtn() {
    const [current, setCurrent] = useState(0); // for next & prev slides
    const length = SliderDataRockyMtn.length;
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Rocky Mountain National Park</h1>
            <h2 className='city'>Colorado, USA</h2>
            <div className='slider'>
                ...
                {SliderDataRockyMtn.map((slide, index) => {
                    return (
