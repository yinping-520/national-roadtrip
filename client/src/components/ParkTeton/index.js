...
function Teton() {
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Grand Teton National Park</h1>
            ...
            <div className='slider'>
                ...
                {SliderDataTeton.map((slide, index) => {
                    return (
