...
import { SliderDataYellowstone } from '../SliderData';
...
function Yellowstone() {
    ...
    const length = SliderDataYellowstone.length;
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Yellowstone National Park</h1>
            <h2 className='city'>Wyoming, USA</h2>
            <div className='slider'>
                ...
                {SliderDataYellowstone.map((slide, index) => {
                    return (
