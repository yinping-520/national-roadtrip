...
function Smokey() {
    ...
    return (
        <div>
            <div id='center-all'>
            <h1 className='park-name'>Smokey Mountains</h1>
            <h2 className='city'>North Carolina, USA</h2>
            <div className='slider'>
                ...
                {SliderDataSmokey.map((slide, index) => {
                    return (
